...
// 2.6.0 has incorrect release artifacts
version "2.4.0" "2.4.1" "2.5.0" "2.5.1" "2.6.1" "2.6.2" "2.6.3" "2.6.4" "2.6.5" "2.6.6"
        "2.6.7" "2.6.8" "2.6.9" "2.6.10" "2.6.11" "2.6.12" "3.0.0" "3.0.1" "3.0.2" "3.0.3"
        "3.0.4" "3.0.5" "3.0.6" "3.0.7" "3.0.8" "3.0.9" "3.0.10" "3.0.11" "3.0.12" "3.1.0"
        "3.1.1" "3.1.2" "3.1.3" "3.1.4" "3.1.5" "3.1.6" "3.1.7" "3.2.5" "3.2.6" "3.2.7" "3.2.8"
        "3.3.2" "3.3.3" "3.3.4" "3.3.5" "3.3.6" "3.3.7" "3.4.0" "3.4.1" "3.4.2" "3.4.3" "3.4.4" {
  strip = 1
